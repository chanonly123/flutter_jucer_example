...
Future<void> main() async {
  ...
  JuceLibGen lib = JuceLibGen(defaultTargetPlatform == TargetPlatform.iOS ? DynamicLibrary.process() : DynamicLibrary.open("libjuce_jni.so"));
  int result = lib.juce_add(2, 3);
  print("result: $result");
  ...
  var reverbOutput = lib.juce_apply_reverb_effect(input.toNativeUtf8(), output.toNativeUtf8());
